		...
		<div class="panel col-12">
			...
			<div class="grid-container">
                ...
                <div class="grid-col-10" style="margin: 0;padding: 0;">
                	...
                	<select class="form-control createitem" name="txtComplaint" id="txtComplaint" style="width:40%">
                        <option>---</option>
                ...
                <div class="grid-col-10" style="margin: 0;padding: 0;">
                    ...
                    <tr><td width="100%">
                  <div style="background: #ccc;">
                	 <select class="form-control createitem" id="txtRcvBy" name="txtRcvBy" style="width:41%;padding: 10pt 0pt;">
          					<option></option>
        			...
        			<input type="date" class="form-control createitem" name="dtRcv" id="dtRcv" style="width:20%;">
                    ...
                    <input type="time" class="form-control createitem" name="timeRcv" id="timeRcv" style="width:20%;">
                  </div>
                    </td>
                      </tr>
                    </table>
                ...
                <div class="grid-col-10" style="margin: 0;padding: 0;">
                  <table width="100%" border="0">
                    <tr><td width="100%">
                        <div style="background: #ccc;">
                      <input type="text" class="form-control createitem" name="txtAtmID" id="txtAtmID" style="width: 19%;" readonly placeholder="ATM ID" required>
                        <button id="openListModal" type="button" style="width: 10%;padding: 9pt 0pt;cursor: pointer;">Select</button>
                         ...
                         <input type="text" class="form-control createitem" id="txtBrand" style="width:12%;" readonly>
                         <input type="text" class="form-control createitem" id="bankblock" disabled value="BANK" style="width:10%;color: blue;font-weight: bold;">
                          <input type="text" class="form-control createitem" id="txtBank" style="width:12%;" readonly>
                         <input type="text" class="form-control createitem" disabled id="siteblock" value="SITE" style="width:10%;color: blue;font-weight: bold;">
                          <input type="text" class="form-control createitem" id="txtSite" style="width:13%;" readonly>
                        </div>
                    </td>
                    </tr>
                    </table>
                ...
                <div class="grid-col-10" style="margin: 0;padding: 0;">
                   <table width="100%" border="0">
                    <tr><td width="100%">
                       <div style="background: #ccc;">
                       <input type="text" class="form-control createitem" name="txtReportedBy" id="txtReportedBy" style="width:49%;" placeholder="( Type Here )">
              ...
              <input type="date" class="form-control createitem" name="dtPersonAssign" id="dtPersonAssign" style="width:20%;">
                ...
                <div class="grid-col-10" style="margin: 0;padding: 0;">
                   <table width="100%" border="0">
                    <tr><td width="100%">
                       <div style="background: #ccc;">
                       <input type="date" class="form-control createitem" name="txtTargetDate" id="txtTargetDate" style="width:99%;">
                     </div>
                    </td>
                  </tr>
                </table>
                ...
                <button type="button" id="createticket" class="btn btn-primary">CREATE</button> 
