...
Route::make('create',function(){
	auth::checkAuth();
	$GLOBALS['ticketcontroller']->index(new atmcontroller,new usercontroller,new complaintcontroller,new techcontroller);
	exit;
});
...
Route::make('updateticket',function(){
	auth::checkAuth();
	$GLOBALS['ticketcontroller']->updateticket(new atmcontroller,new usercontroller,new techcontroller);
	exit;
});
...
Route::make('technicianlist',function(){
	auth::checkAuth();
	$GLOBALS['techcontroller']->index();
	exit;
});

Route::make('createnewtech',function(){
	auth::checkAuth();
	$GLOBALS['techcontroller']->createnewtech();
	exit;
});

Route::make('removetech',function(){
	auth::checkAuth();
	$GLOBALS['techcontroller']->removetech();
	exit;
});


Route::make('updatetech',function(){
	auth::checkAuth();
	$GLOBALS['techcontroller']->updatetech();
	exit;
});
